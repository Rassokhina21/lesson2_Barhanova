...
public class Test0004 {
    private static final Logger logger = LogManager.getLogger(Test0004.class);


    private WebDriver driver;
    private String localUrl = "http://0.0.0.0:4444/wd/hub";
    private String newsLink = "//a[2]/h3";
    private String newsTitle = "ИТ Новости на Хабре: главные новости технологий";
    ...
    @Test
    void test(){
        driver.findElement(By.xpath(newsLink)).click();
        String actualTitle = driver.getTitle();
        Assert.assertEquals(actualTitle, newsTitle);
        logger.info("Тест 0004 прошел успешно");
