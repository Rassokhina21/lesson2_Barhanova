...
public class Test0001 {
    private static final Logger logger = LogManager.getLogger(Test0001.class);


    private WebDriver driver;
    private String localUrl = "http://0.0.0.0:4444/wd/hub";
    private String autorsLink = "//a[4]/h3";
    private String autorsTitle = "Пользователи - Топ 100 / Хабр";
